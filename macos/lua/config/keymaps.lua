...
end, { noremap = true, silent = true, desc = "Toggle Live Server" })

-- Start Live Server with <leader>ls
vim.keymap.set("n", "<leader>ls", function()
  require("live-server-nvim").start()
end, { noremap = true, silent = true, desc = "Start Live Server" })

-- Stop Live Server with <leader>le
vim.keymap.set("n", "<leader>le", function()
  require("live-server-nvim").stop()
end, { noremap = true, silent = true, desc = "Stop Live Server" })
